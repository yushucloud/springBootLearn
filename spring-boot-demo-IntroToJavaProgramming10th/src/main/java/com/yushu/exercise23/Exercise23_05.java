...
import com.yushu.exercise13.Circle;
...
public class Exercise23_05 {
  ...
  public static<E>void heapSort(Circle[] list,
                                GeometricObjectComparator comparator) {
    // Create a Heap
    HeapWithComparator<E> heap = new HeapWithComparator<E>((Comparator<? super E>) comparator);
